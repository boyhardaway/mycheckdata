...
module.exports = {
  async calScore(objScore) { 
    ...
    // resScr.knockout.a.matches[0].home_result = 1;
    // resScr.knockout.a.matches[0].away_result = 0;

    // resScr.knockout.a.matches[1].home_result = 0;
    // resScr.knockout.a.matches[1].away_result = 2;

    // resScr.knockout.b.matches[3].home_result = 0;
    // resScr.knockout.b.matches[3].away_result = 2;
